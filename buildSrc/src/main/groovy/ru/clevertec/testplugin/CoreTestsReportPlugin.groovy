...
class CoreTestsReportPlugin implements Plugin<Project> {
    ...
    private static final String DELETE_REPORTS_DIRECTORY = 'deleteReportsDirectory'
    ...
    void apply(Project project) {
        ...
        project.tasks.register(TEST_REPORT, Copy) {
            ...
            finalizedBy(DELETE_REPORTS_DIRECTORY)
        }
        ...
        project.tasks.register(DELETE_REPORTS_DIRECTORY, Delete) {
            delete project.layout.buildDirectory.dir(REPORTS_DIRECTORY)
        }
    }
}
